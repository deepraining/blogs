...
在这种情况下，我们就想要寻求一种更好的解决方案，这便是 [rollup](https://github.com/rollup/rollup).
...
更多详细的用法，参考 [rollup.js](https://rollupjs.org/guide/en).
...
2. 执行很快，因为 webpack bundle 中的 `__webpack_require__`, `Object.defineProperty` 之类的冗余代码；
