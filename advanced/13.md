...
如果你将当前的项目发布为一个 npm 包，而其他的包在引用你的包是，构建工具就会去找 `main` 字段定义的入口文件。

还有其他的特殊的入口文件，参考 [package.json 非官方字段集合](https://github.com/senntyou/blogs/blob/master/extend/3.md) 与 [package.json#main](https://docs.npmjs.com/files/package.json#main)。
