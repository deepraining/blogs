...
另外，可以参考 [目录结构优化](https://github.com/senntyou/blogs/blob/master/advanced/2.md)
...
选好基础 `js` 框架后，可以选一个比较好的 ui 框架，这样可以少写很多代码，参考 [前端最受欢迎的 UI 框架](https://github.com/senntyou/blogs/blob/master/intro/1.md)。
