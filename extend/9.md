...
之前讲了很多关于项目工程化、前端架构、前端构建等方面的技术，这次说说怎么写一个好的第三方库。
...
可以查看 [webpack 之外的另一种选择：rollup](../advanced/6.md) 了解 `webpack` 与 `rollup` 的差异与优势。
...
详细的文件与工具，参考 [搭建自己的前端脚手架](../advanced/13.md)。
