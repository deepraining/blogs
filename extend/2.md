...
- [ignite](https://github.com/infinitered/ignite): [redux](https://github.com/reduxjs/redux)、[redux-saga](https://github.com/redux-saga/redux-saga)、[storybook](https://github.com/storybooks/storybook)、[enzyme](https://github.com/airbnb/enzyme)、[jest](https://github.com/facebook/jest)、[standard](https://github.com/standard/standard)
- [snowflake](https://github.com/bartonhammond/snowflake): [redux](https://github.com/reduxjs/redux)、[redux-thunk](https://github.com/reduxjs/redux-thunk)、[jest](https://github.com/facebook/jest)、[eslint](https://github.com/eslint/eslint)
