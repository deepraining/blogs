...
独立化组件与私有 npm 仓库配合使用是最完美的，下一节 [私有 npm 仓库](https://github.com/senntyou/blogs/blob/master/architecture/7.md) 将会讲到这个。

```
# npm
$ npm config set registry http://youor.company.npm.registry.com
...
#### dev, dist `@yourCompany/component1` 的开发代码
